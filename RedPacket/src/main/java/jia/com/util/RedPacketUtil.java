 ...
 * @author leo-zeng
 */
public abstract class RedPacketUtil {
    /**
     ...
     * 拆分一个红包
     */
    public static Integer splitRedPacket(int money, int count) {
        //红包 合法性校验
    ...
    private static int randomRedPacket(int money, int minS, int maxS, int count) {
        ...
        //校验 最大值 max 要是比money 金额高的话？ 取 money 金额
    ...
    public static void main(String[] args) {
        //随机一个188.88  5个红包
        //单位是分
        System.out.println("" + splitRedPacket(18888, 1));
    }
}